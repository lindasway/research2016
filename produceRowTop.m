function nmatrow = produceRowTop(noteType, freq, bpm)
...
nmatrow(1, 1) = onsetInBeatstop;
nmatrow(1, 2) = numBeats;
nmatrow(1, 3) = 1;
nmatrow(1, 4) = midiPitch;
nmatrow(1, 5) = 127;
nmatrow(1, 6) = prevtimetop;
nmatrow(1, 7) = secspn(noteType);
prevtimetop = prevtimetop + secspn(noteType);
onsetInBeatstop = onsetInBeatstop + numBeats;
end
